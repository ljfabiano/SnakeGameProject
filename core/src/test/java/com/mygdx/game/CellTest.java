...
public class CellTest {
    ...
    public void addBodyCellToList() throws Exception
    {
        ...
        testHeadCell.addBodyCellToList(testFoodBodyAdd);

        System.out.println("new food segment x = " + testFoodBodyAdd.getX());
        System.out.println("new food segment y = " + testFoodBodyAdd.getY());
        System.out.println("new food segment type = " + testFoodBodyAdd.getType());
        ...
        assertEquals(testHeadCell.getBody().get(testHeadCell.getLength() -1), testFoodBodyAdd);
        ...
        assertEquals(testHeadCell.getBreadCrumbsList().get(testHeadCell.getLength() -1).getX(), testFoodBodyAdd.getX());
        assertEquals(testHeadCell.getBreadCrumbsList().get(testHeadCell.getLength() -1).getY(), testFoodBodyAdd.getY());
    }
